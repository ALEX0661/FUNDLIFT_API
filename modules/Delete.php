...
class Delete extends Common {
    ...
    public function deleteCampaign($id) {
        try {
            ...
            $this->logger($this->getUsername(), $this->getUserId(), "DELETE", "Deleted the campaign record with ID: $id and all related pledges");
            ...
            $this->pdo->rollBack();
            $this->logger($this->getUsername(), $this->getUserId(), "DELETE", $e->getMessage());
    ...
    public function deletePledge($id) {
        try {
            ...
            if ($pledge['is_archived'] == 0) {
                $this->logger($this->getUsername(), $this->getUserId(), "DELETE", "failed to destroy a pledge recored");
            ...
            $this->logger($this->getUsername(), $this->getUserId(), "DELETE", "Deleted pledge with ID $id.");
